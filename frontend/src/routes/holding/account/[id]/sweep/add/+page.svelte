<!--
  Auto-sweep — Add rule — coming-soon stub.
  Reached from the Account detail page Settings tab "Add rule" row for the
  auto-sweep section.
  The full auto-sweep rule creation (trigger threshold, destination, schedule)
...
<div class="phone-screen safe-top safe-bottom">
  ...
  <div class="app-bar">
    ...
    <div class="screen-title">Add auto-sweep rule</div>
    <div></div>
  </div>
