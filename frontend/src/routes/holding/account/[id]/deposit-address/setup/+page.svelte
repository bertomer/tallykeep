<!--
  Deposit address — Set up — coming-soon stub.
  Reached from the Account detail page Settings tab "Set up" row for the
  on-chain deposit address section.
  The full deposit-address setup (derivation, labelling, QR display) is a
  future iteration.
-->
<script lang="ts">
...
<div class="phone-screen safe-top safe-bottom">
  ...
  <div class="app-bar">
    ...
    <div class="screen-title">Set up deposit address</div>
    <div></div>
  </div>
  ...
  <div class="scroll-area">
    <div class="stub-body">
      ...
      <h1 class="stub-heading">Set up deposit address</h1>
      <h2 class="stub-subheading">Coming in an upcoming iteration</h2>

      <p class="stub-body-text">
        Deriving and labelling a deposit address for your exchange Account —
        including QR-code display and clipboard copy — will be set up here.
        This flow ships in the next design pass.
      </p>
