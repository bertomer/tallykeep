<!--
  Deposit in — coming-soon stub.
  Reached from the Account detail page "Deposit in" action card.
  The full deposit-address / QR-code flow is a future iteration.
-->
<script lang="ts">
...
<div class="phone-screen safe-top safe-bottom">
  ...
  <div class="app-bar">
    ...
    <div class="screen-title">Deposit in</div>
    <div></div>
  </div>
  ...
  <div class="scroll-area">
    <div class="stub-body">
      ...
      <h1 class="stub-heading">Deposit in</h1>
      <h2 class="stub-subheading">Coming in an upcoming iteration</h2>

      <p class="stub-body-text">
        Deposit-address generation and QR-code display for your exchange
        Account will be configurable here. The full on-chain deposit flow
        ships in the next design pass.
      </p>
