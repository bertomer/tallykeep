<!--
  Withdrawal key — Set up — coming-soon stub.
  Reached from the Account detail page Settings tab "Set up" row for the
  withdrawal credential section.
  The full ADR-0011 two-key setup (withdrawal key, whitelist, policy) is a
  future iteration.
-->
<script lang="ts">
...
<div class="phone-screen safe-top safe-bottom">
  ...
  <div class="app-bar">
    ...
    <div class="screen-title">Set up withdrawal key</div>
    <div></div>
  </div>
  ...
  <div class="scroll-area">
    <div class="stub-body">
      ...
      <h1 class="stub-heading">Set up withdrawal key</h1>
      <h2 class="stub-subheading">Coming in an upcoming iteration</h2>

      <p class="stub-body-text">
        The withdrawal credential (ADR-0011 second key) — separate from the
        read-only observation key — will be configured here. Includes
        whitelist-address setup and withdrawal-policy creation.
      </p>
