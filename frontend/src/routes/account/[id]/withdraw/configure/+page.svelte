<!--
  Withdrawal configure — coming-soon stub.
  Reached from the Account wizard's Step 3 "Set up auto-sweep" suggestion card.
  The full sub-flow (2-key model, whitelist setup, sweep policy creation) is a
  future iteration. This stub confirms the route exists and returns the user to
  Home.
-->
<script lang="ts">
...
<div class="phone-screen safe-top safe-bottom">
  ...
  <div class="app-bar">
    ...
    <div class="screen-title">Set up auto-sweep</div>
    <div></div>
  </div>
  ...
  <div class="scroll-area">
    <div class="stub-body">
      ...
      <h1 class="stub-heading">Auto-sweep setup</h1>
      <h2 class="stub-subheading">Coming in an upcoming iteration</h2>

      <p class="stub-body-text">
        Automated withdrawals from your exchange Account to a self-custody
        Holding will be configurable here. The full two-key setup — withdrawal
        credential, whitelist address, and sweep policy — ships in the next
        design pass.
      </p>
